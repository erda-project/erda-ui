...
const Mock = () => {
  return <DiceConfigPage showLoading scenarioType="mock" scenarioKey={'mock'} useMock={useMock} />;
};
export default Mock;

const useMock = (payload: any, partial: any) => {
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve(getMock(payload, partial));
    }, 100);
  });
};
