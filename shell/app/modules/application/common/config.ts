...
export const modeOptions = [
  {
    ...
    src: ywyy_svg,
    desc: i18n.t('dop:Business apps mainly refer to a combination of microservices that handle certain types of business processes, such as member management apps.', { keySeparator: '>' }),
    groupIndex: 1,
    disabled: false,
  },
  {
  ...
  },
  {
    ...
    src: xmjyy_svg,
    desc: i18n.t('dop:Once set as a project-level app, the pipeline of this app can directly call the pipeline of other apps in the project.'),
    groupIndex: 1,
    disabled: false,
  },
];
