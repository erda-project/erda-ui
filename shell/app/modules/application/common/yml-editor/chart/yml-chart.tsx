...
import { externalKey, CHART_CONFIG } from '../config';
...
// const onDrag = false;
const YmlChart = (props: IProps) => {
  const { data, zoom = 1, chartConfig: propsChartConfig, editing, ...rest } = props;
