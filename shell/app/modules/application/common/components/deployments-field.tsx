...
import { InputNumber, Select } from 'nusi';
...
export default class extends PureComponent<IVariableInputGroupProps, any> {
  ...
  public render() {
    ...
    const replicas = (
      <div>
        <span className="edit-service-label">{i18n.t('application:instances count')}: </span>
        <span>
          <InputNumber
            disabled={disabled}
            ...
            placeholder={i18n.t('application:please enter the instances count')}
          />
        </span>
      </div>
    );
