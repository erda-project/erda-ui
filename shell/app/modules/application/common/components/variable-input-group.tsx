  ...
  public render() {
    ...
    return (
      <div className="variable-input-group">
        ...
        {lock !== false ? <Icon type="lock" className="variable-icon variable-input-lock" /> : null}
        {disabled ? null : <Icon type="delete" className={`variable-icon ${lock === false && 'ml12'}`} onClick={() => onDelete(key)} />}
      </div>
    );
  }
