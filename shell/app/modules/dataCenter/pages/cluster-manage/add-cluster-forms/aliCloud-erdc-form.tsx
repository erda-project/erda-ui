      ...
      >
        <Form
          ...
          formRender={({ RenderFields, form, fields: totalFields }: any) => {
            ...
            return (
              <>
                <div className="font-bold mb-1">{i18n.t('dataCenter:cluster configuration')}</div>
                <RenderFields form={form} fields={bFields} />
                <div className="font-bold mb-1">{i18n.t('dataCenter:jump server configuration')}</div>
                <RenderFields form={form} fields={sFields} />
                <div className="font-bold mb-1">{i18n.t('dataCenter:shared storage')}</div>
                <RenderFields form={form} fields={stFields} />
                <div className="font-bold mb-1">{i18n.t('dataCenter:network configuration')}</div>
                <RenderFields form={form} fields={dFields} />
                <div className="font-bold mb-1">{i18n.t('dataCenter:domain name server')}</div>
                <RenderFields form={form} fields={seFields} />
                <div className="font-bold mb-1">{i18n.t('dataCenter:machine information configuration')}</div>
