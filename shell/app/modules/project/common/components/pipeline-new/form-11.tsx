...
import { Form, Button, TreeSelect, Tooltip, Popover, Drawer, Dropdown, Menu } from 'antd';
import i18n from 'i18n';
import { useEffectOnce } from 'react-use';
import { ErdaIcon, RenderFormItem, ErdaAlert, RenderForm } from 'common';
...
const PipelineTitle = ({ node, clickCallback }: { node: Node; clickCallback: () => void }) => {
      ...
      {node.type !== 'f' ? (
        ...
        >
          <div
            ...
            className="px-1 invisible group-hover:visible text-lg text-purple-deep"
          >
            +
          </div>
        </Popover>
                      ...
                      <div className="flex">
                        <TreeSelect
                          ...
                          onDropdownVisibleChange={(_visible) => {
                            console.log('------_vis', _visible, canTreeSelectClose.current);
