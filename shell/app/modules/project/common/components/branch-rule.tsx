...
const extraFieldsMap = {
  app: [
    ...
    },
    {
      ...
      required: true,
      labelTip: i18n.t('dop:When enabled, only the app owner and leader can perform operations, and other members can only submit code through MR.'),
      type: 'switch',
    },
  ],
  project: [
