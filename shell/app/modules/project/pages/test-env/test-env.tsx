  ...
  return (
    <Spin spinning={loading}>
      ...
      <Alert
        ...
        message={
          testType === 'manual' ? i18n.t('project:This parameter is provided to the use case interface of Manual Test in Test Case.') : i18n.t('project:This parameter is provided to the use case interface of Automated Interface Test in Test Case.')
        }
        type="normal"
        showIcon
      />
