    ...
    <div className="flex-box content-wrap">
      ...
      <div className="right flex-1 pl16">
        <div className="flex-box">
          <div className="title color-text bold-500 text-base my12">{i18n.t('related instance')}</div>
        ...
        <div className="title color-text bold-500 text-base mb12">{i18n.t('version list')}</div>
