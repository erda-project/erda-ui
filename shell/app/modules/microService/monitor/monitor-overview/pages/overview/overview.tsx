...
const PVUVCharts = () => (
  <MonitorPanel className="main-panel" title={i18n.t('microService:visit (7 days)')}>
...
const BICharts = () => (
  <MonitorPanel className="main-panel" title={i18n.t('microService:browser access performance (within 1 hour)')}>
    <Row>
      <Col>
...
const AICharts = () => (
  <MonitorPanel className="main-panel" title={i18n.t('microService:application performance trends (within 1 hour)')}>
    <Row className="last-line">
      <Col span={12}>
