...
const HttpForm = ({ data, submitForm }: IHttpForm) => {
  ...
  const fieldsList = [
    ...
    {
      label: i18n.t('microService:maximum number of waiting requests'),
    ...
    {
      label: i18n.t('microService:shortest isolation time'),
    ...
    {
      label: i18n.t('microService:largest isolation ratio'),
      ...
      <div className="service-mesh-forms-container h-full">
        <div className="service-mesh-search">
          ...
          <div className="hide-no-rule-interface h-full">
            <span className="hide-no-rule-interface-label h-full">{i18n.t('microService:hide no rule interface')}</span>
            <Switch
              checked={hideNoRule}
              checkedChildren="ON"
