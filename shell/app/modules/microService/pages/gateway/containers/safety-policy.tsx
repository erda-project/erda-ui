    ...
    <div className="safety-section mb32">
      <Collapse defaultActiveKey={['waf', 'ip', 'guard', 'csrf']}>
        ...
        >
          ...
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('microService:traffic intercept switch')}</span>
            <div className="policy-content">
              <Select className="safety-select" disabled={enableGlobalWaf} value={wafEnable} onChange={(option: string) => setWafEnable(option)}>
                <Option key="watch" value="watch">{i18n.t('microService:observation mode')}</Option>
                <Option key="on" value="on">{i18n.t('microService:open')}</Option>
              </Select>
            </div>
          </div>
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('microService:remove rule')} ID</span>
            <div className="policy-content">
              <Input className="policy-input" disabled={enableGlobalWaf} spellCheck={false} onChange={onChangeRemovedRules} value={removeRules} placeholder={i18n.t('microService:input rule id separated by space')} />
            </div>
          </div>
          <div className="gateway-policy-item">
            <Button
        ...
        >
          <div className="gateway-policy-item">
            <span className="policy-label">
              {i18n.t('user')} IP {i18n.t('microService:source')}
            </span>
            <div className="policy-content">
              <Select
                className="ip-select"
              ...
              >
                ...
                <Option key="xForwardFor" value="xForwardFor">
                  {i18n.t('microService:request header')} x-forwarded-for
                </Option>
              </Select>
            </div>
          </div>
              ...
              <div className="policy-content mb16">
                ...
                >
                  <Option key="black" value="black">
                    {i18n.t('microService:blacklist')}
                  </Option>
                  <Option key="white" value="white">
                    {i18n.t('microService:whitelist')}
                  </Option>
                </Select>
              </div>
              <div className="policy-content">
