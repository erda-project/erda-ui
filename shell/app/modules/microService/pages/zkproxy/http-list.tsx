...
import { Table, Badge, Modal, Tooltip } from 'nusi';
...
const HTTPList = () => {
  const columns = [
    {
      title: i18n.t('microService:service name'),
      dataIndex: 'serviceName',
    },
    {
      title: i18n.t('microService:domain'),
        ...
        render: (subRecord: IHttpServiceDto) => {
          return (
            <div className="table-operations">
              ...
              >
                {subRecord.online ? i18n.t('microService:offline') : i18n.t('microService:online')}
              </span>
            </div>
          );
        },
