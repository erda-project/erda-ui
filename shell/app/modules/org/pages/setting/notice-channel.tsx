...
const NotifyChannel = () => {
  ...
  return (
    <div className="relative notice-channel">
      <Tooltip title={i18n.t('Add-notification-channel')}>
        <div
        ...
        >
          <Button type="primary">{i18n.t('Add-notification-channel')}</Button>
        </div>
      </Tooltip>
      <FormModal
        width={800}
        title={`${isEditing ? i18n.t('edit notification channel') : i18n.t('Add-notification-channel')}`}
        visible={visible}
