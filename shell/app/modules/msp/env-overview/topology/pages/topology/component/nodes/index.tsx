...
const customerNode = (onMouseMoving: IProps['onMouseMoving']) => {
  return {
    apigateway: (props: NodeProps<TOPOLOGY.TopoNode>) => {
      return <ApiGatewayNode {...props} onMouseMoving={onMouseMoving} />;
    },
    service: (props: NodeProps<TOPOLOGY.TopoNode>) => {
      return <ServicesNode {...props} onMouseMoving={onMouseMoving} />;
    },
    externalservice: (props: NodeProps<TOPOLOGY.TopoNode>) => {
      return <ExternalServiceNode {...props} onMouseMoving={onMouseMoving} />;
    },
    addon: (props: NodeProps<TOPOLOGY.TopoNode>) => {
      return <AddonNode {...props} onMouseMoving={onMouseMoving} />;
    },
  };
};
