...
import CardList, { CardColumnsProps } from 'msp/components/card-list';
  ...
  ErrorRate: [
    {
      ...
      tips: i18n.t(
        'msp:The ratio of the number of incorrect requests to the total number of requests in the last hour',
      ),
    },
  ],
};
