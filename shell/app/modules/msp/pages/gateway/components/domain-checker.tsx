      ...
      content={
        <div className="domain-content">
          <div className="mb8 domain-addr">
            ...
            <Copy className="for-copy" data-clipboard-tip={i18n.t('msp:external network address')}>
              : {outerAddr}
            </Copy>
          </div>
          <Tooltip title={innerTips}>
            <div className="domain-addr">
              ...
              <Copy className="for-copy" data-clipboard-tip={i18n.t('msp:internal network address')}>
                : {innerAddr}
              </Copy>
            </div>
          </Tooltip>
