                      ...
                      case 'input':
                        CompItem = (
                          <Input
                            key={key}
                            value={data[key]}
                            placeholder={i18n.t('Please enter the {name}', { name: label || key })}
                            onChange={(e) => updateItem({ [key]: e.target.value })}
                            {...itemComponentProps}
                          />
                        );
                                  ...
                                  return (
                                    <FormItem colon key={_k} label={_k} required={false}>
                                      <Input
                                        key={_k}
                                        value={curVal}
                                        placeholder={i18n.t('Please enter the {name}', { name: _k })}
                  ...
                  <div key={_data.key}>
                    <FormItem colon label={'属性key'} required>
                      <Input
                        key={'key'}
                        value={_data.key}
                        placeholder={i18n.t('Please enter the {name}', { name: '属性key' })}
                        onChange={(e) => updateItem({ key: e.target.value })}
                      />
                    </FormItem>
                    <FormItem colon label={'属性标签'} required={false}>
                      <Input
                        key={'label'}
                        value={_data.label}
                        placeholder={i18n.t('Please enter the {name}', { name: '属性标签' })}
                    ...
                    <FormItem colon label={'属性标签提示'} required={false}>
                      <Input
                        ...
                        placeholder={i18n.t('Please enter the {name}', { name: '属性标签提示' })}
                    ...
                    <FormItem colon label={'组件'} required={false}>
                      <Select
                        ...
                        placeholder={i18n.t('please select the {name}', { name: '组件' })}
