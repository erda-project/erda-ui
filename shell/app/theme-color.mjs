...
const colors = {
  ...
  red: '#FA5446',
  'red-1': 'rgba(250,84,70,0.1)',
  danger: 'rgba(250,84,70,1)',
  error: 'rgb(250,84,70, 74)',
  blue: 'rgba(36, 150, 255,1)',
  'blue-1': 'rgba(36, 150, 255,0.1)',
  info: 'rgba(36, 150, 255,1)',
  yellow: 'rgba(255, 145, 44,1)',
  'yellow-1': 'rgba(255, 145, 44,0.1)',
  warning: 'rgba(255, 145, 44,1)',
  green: 'rgba(13, 212, 117,1)',
  'green-1': 'rgba(13, 212, 117,0.1)',
  success: 'rgba(13, 212, 117,1)',
  orange: '#f47201',
  purple: '#6a549e',
  cyan: '#5bd6d0ff',
  gray: '#666666',
