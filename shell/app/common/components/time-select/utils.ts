...
export const relativeTimeRange = {
  'minutes:15': `${i18n.t('last')} ${i18n.t('{count} minute', { count: 15 })}`,
  'minutes:30': `${i18n.t('last')} ${i18n.t('{count} minute', { count: 30 })}`,
  'hours:1': `${i18n.t('last')} ${i18n.t('{count} hour', { count: 1 })}`,
  'hours:3': `${i18n.t('last')} ${i18n.t('{count} hour', { count: 3 })}`,
  'hours:6': `${i18n.t('last')} ${i18n.t('{count} hour', { count: 6 })}`,
  'hours:12': `${i18n.t('last')} ${i18n.t('{count} hour', { count: 12 })}`,
  'days:1': `${i18n.t('last')} ${i18n.t('{count} day', { count: 1 })}`,
  'days:3': `${i18n.t('last')} ${i18n.t('{count} day', { count: 3 })}`,
  'weeks:1': `${i18n.t('last')} ${i18n.t('{count} week', { count: 1 })}`,
  'months:1': `${i18n.t('last')} ${i18n.t('{count} mouth', { count: 1 })}`,
  'months:3': `${i18n.t('last')} ${i18n.t('{count} mouth', { count: 3 })}`,
  'months:6': `${i18n.t('last')} ${i18n.t('{count} mouth', { count: 6 })}`,
  today: i18n.t('today'),
