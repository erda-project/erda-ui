  ...
  React.useEffect(() => {
    ...
    if (dataSource.length) {
      ...
      if ((first as ITabItemGroup).groupTitle) {
        ...
        map(dataSource as any, (group: ITabItemGroup) => map(group.tabGroup, (tab: ITabItem) => { tabMap[tab.tabKey] = tab; }));
      } else {
        activeTab = first;
        map(dataSource as any, (tab: ITabItem) => { tabMap[tab.tabKey] = tab; });
      }
    }
