...
export enum pages {
  ...
  projectPipelineConfigEnv = '/{orgName}/dop/projects/{projectId}/pipelines/config/{workspace}',
  ...
  appCreateMr = '/{orgName}/dop/projects/{projectId}/apps/{appId}/repo/mr/open/createMR',
  ...
  mspProjectNotifyGroup = '/{orgName}/msp/{projectId}/{env}/{tenantGroup}/alarm-management/{terminusKey}/config/notify-group',
  ...
  issues = '/{orgName}/dop/projects/{projectId}/issues/all',
  ...
  cmpAlarmConfig = '/{orgName}/cmp/alarm/config',
