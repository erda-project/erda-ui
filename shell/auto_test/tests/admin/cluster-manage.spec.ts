...
Role('Admin', () => {
  test('cluster manage', async ({ page, wait, expectExist }, testInfo) => {
    ...
    // Click text=Clusters
    await Promise.all([
      page.waitForNavigation(/*{ url: 'https://erda.daily.terminus.io/-/sysAdmin/cluster-manage?pageNo=1' }*/),
    ...
    await Promise.all([
      page.waitForNavigation(/*{ url: 'https://erda.daily.terminus.io/-/sysAdmin/cluster-manage?orgName=integration&pageNo=1' }*/),
    ...
    await Promise.all([
      page.waitForNavigation(/*{ url: 'https://erda.daily.terminus.io/-/sysAdmin/cluster-manage?orgName=keyifangshujiazuzhi&pageNo=1' }*/),
    ...
    expect(page.url()).toBe(
      'https://erda.daily.terminus.io/-/sysAdmin/cluster-manage/history?recordType=upgradeEdgeCluster&scope=system',
    );
