...
Role('Manager', () => {
  test('add-ticket', async ({ page, expectExist, goTo }) => {
    ...
    // Click text=Issues
    await Promise.all([
      page.waitForNavigation(/*{ url: 'https://erda.daily.terminus.io/erda/dop/projects/1/apps/16/ticket/open?pageNo=1' }*/),
    ...
    await Promise.all([
      page.waitForNavigation(/*{ url: 'https://erda.daily.terminus.io/erda/dop/projects/1/apps/16/ticket/open?pageNo=1&type=codeSmell' }*/),
      page.click('text=code smell'),
    ]);
    await page.click('text=no-labelfilter by priority >> input[role="combobox"]');
    await Promise.all([
      page.waitForNavigation(/*{ url: 'https://erda.daily.terminus.io/erda/dop/projects/1/apps/16/ticket/open?pageNo=1&priority=low&type=codeSmell' }*/),
      page.click('form >> :nth-match(:text("low"), 2)'),
    ]);
    await Promise.all([
      page.waitForNavigation(/*{ url: 'https://erda.daily.terminus.io/erda/dop/projects/1/apps/16/ticket/open?pageNo=1&q=aaaaaa&type=bug' }*/),
