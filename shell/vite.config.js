...
export default ({ command, mode }) => {
  let alias = [
    ...
    { find: 'msp', replacement: path.resolve(__dirname, './app/modules/extra/msp') },
    ...
    {
      find: 'monitor-overview',
      replacement: path.resolve(__dirname, './app/modules/extra/msp/monitor/monitor-overview'),
    },
    {
      find: 'external-insight',
      replacement: path.resolve(__dirname, './app/modules/extra/msp/monitor/external-insight'),
    },
    {
      find: 'browser-insight',
      replacement: path.resolve(__dirname, './app/modules/extra/msp/monitor/browser-insight'),
    },
    {
      find: 'gateway-ingress',
      replacement: path.resolve(__dirname, './app/modules/extra/msp/monitor/gateway-ingress'),
    },
    {
      find: 'docker-container',
      replacement: path.resolve(__dirname, './app/modules/extra/msp/monitor/docker-container'),
    },
    { find: 'api-insight', replacement: path.resolve(__dirname, './app/modules/extra/msp/monitor/api-insight') },
    { find: 'trace-insight', replacement: path.resolve(__dirname, './app/modules/extra/msp/monitor/trace-insight') },
    { find: 'monitor-common', replacement: path.resolve(__dirname, './app/modules/extra/msp/monitor/monitor-common') },
    { find: 'topology', replacement: path.resolve(__dirname, './app/modules/extra/msp/monitor/topology') },
    { find: 'status-insight', replacement: path.resolve(__dirname, './app/modules/extra/msp/monitor/status-insight') },
    { find: 'error-insight', replacement: path.resolve(__dirname, './app/modules/extra/msp/monitor/error-insight') },
    { find: 'monitor-alarm', replacement: path.resolve(__dirname, './app/modules/extra/msp/monitor/monitor-alarm') },
    { find: /^~/, replacement: '' },

    { find: '@', replacement: path.resolve(__dirname, './node_modules/erda-pyroscope/src') },
    {
      find: '@pyroscope/models',
      replacement: path.resolve(__dirname, './node_modules/erda-pyroscope/src/components/pyroscope-models'),
    },
    { find: '@webapp/ui', replacement: path.resolve(__dirname, './node_modules/erda-pyroscope/src/ui') },
  ];
